...
const Movies = () => {
    ...
    const fetchTypeMenu = async () => {
        const { data } = await axios.get(
            'https://api.themoviedb.org/3/genre/movie/list?api_key=6de13cb06459580e8f7ab054d9dbb28e&language=en-US',
        );
            ...
            <div>
                <div className={cx('wrapper')}>
                    ...
                    <div className={cx('wrapper-panigation')}>
                        <PaginationSize Movie={true} setPage={setPage} totalPage={totalPage > 500 ? 500 : totalPage} />
                    </div>
                </div>
            </div>
        </Helmet>
