        ...
        <Helmet title="Search">
            <div className="wrapper__search">
                <div onClick={handleScroll}>
                    <span ref={btn} className={'scroll-button'}>
                        <ArrowUpwardIcon />
                    </span>
                </div>
                <FormPropsTextFields
                    setSearchText={setSearchText}
                    fetchMovieBySearch={fetchMovieBySearch}
                ...
                <div className={'wrapper-panigation'}>
                    <PaginationSize
                        Movie={true}
                        setPage={setPageSearch ? setPageSearch : setPageTVSearch}
                        totalPage={totalPageSearch > 500 ? 500 : totalPageSearch}
                    />
                </div>
            </div>
        </Helmet>
